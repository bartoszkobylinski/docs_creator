...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={API Documentation Documentation},
...
\begin{itemize}
    ...
    \item \textbf{Packages:} stream, match\_result\_base, player, test\_routers, player\_stats, serie, stream\_base, game, player\_base, match\_result, match\_base, round\_score\_base, round\_score, player\_result, team, serie\_base, player\_result\_base, tournament, api\_updater, tournament\_base, league\_base, manager, game\_base, match, league, team\_base, player\_stats\_base
\end{itemize}
